...
**Eight/sixteen 256GB servers:** the current allocator retains one share worker on one host and enforces a 256GB total budget. More purchases alone add no reputation; other servers farm hacking. Hypothetical multi-host sharing requires an allocator change (duplicate handling currently retires multiple owned workers), a raised total budget and updated command validation. Live Formulas quotes: eight total servers =496threads/2033.6GB used, power1.252593; sixteen total =992threads/4067.2GB, power1.280319. Relative to the formula's one-server baseline1.169415, gains are approximately7.11% and9.48%. Scaling the current3.365rep/sec gives approximately3.604 and3.684rep/sec; projections assume unchanged work/multipliers. Additional purchase costs after the one already owned: $98.56m (seven more) and $211.20m (fifteen more). Total costs $112.64m/$225.28m. Moving eight→sixteen yields only2.21% more rep for another$112.64m. Recommend keeping one initially, or a bounded eight-total allocation only if reputation clearly outweighs money/XP; sixteen is weak marginal value. No additional purchase or allocator change made. Evidence: `evidence/reputation-objective/cloud-multiple-quote.json`.

**Purchase completed with Ken's authorization:** September 12, mcp-worker-0 (256GB) purchased for $14.08m; MCP restarted and retained reputation mode. Sharing relocated to cloud: 62 threads/254.2GB, observed power1.169990, no reported invariant violations. NiteSec now displays3.365rep/sec at H304; prior3.297 was measured at H303, so the entire rate difference cannot be attributed to capacity alone. The former avmnite-02h allocation is available to hacking again. Evidence `evidence/reputation-objective/cloud-purchased.json`. No further purchase is recommended without sustained opportunity-cost evidence.
