/** Darknet Canary Phase 1 Test Launcher
 *
 * Starts dnet_root.js with MAX_ACTIVE_MANAGERS=1 for controlled testing.
...
export async function main(ns) {
  ...
  const PHASE_1_DURATION = 300000  // 5 minutes in ms
  const START_TIME = Date.now()

  ns.tprint("🔬 Darknet Canary Phase 1 - Single Manager Test")
  ns.tprint("")
  ...
  // Launch dnet_root.js
  ns.tprint("  • Launching dnet_root.js with MAX_ACTIVE_MANAGERS=1")
  ns.tprint("")
  ns.tprint("⏱️  Test running for 5 minutes...")
  ns.tprint("")
  ...
  while (Date.now() - START_TIME < PHASE_1_DURATION) {
  ...
  ns.write("dnet_canary_phase1_completed.txt",
    JSON.stringify({
  ...
  ns.tprint("")
  ns.tprint("✅ Phase 1 test completed successfully")
  ns.tprint("📋 Results written to: dnet_canary_phase1_completed.txt")
}
